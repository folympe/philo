...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/05/25 16:58:33 by olfhal            #+#    #+#             */
/*   Updated: 2026/05/25 16:58:36 by olfhal           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static bool	start_simulation(t_table *table)
{
	...
	table->start_time = get_time_in_ms() + 10;
	i = 0;
...
static void	stop_simulation(t_table *table)
{
	...
	if (DEBUG_FORMATTING && table->must_eat_count != -1)
		write_outcome(table);
